...
- browser - the name of the browser used (for modern browsers, they imitate bussinga and present `true_browser`)
...
{% include support.html table="lua-legacy/window" legacy="true" %}
